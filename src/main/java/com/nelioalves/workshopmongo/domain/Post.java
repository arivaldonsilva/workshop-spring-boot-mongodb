...
public class Post implements Serializable{
	...
	private AuthorDTO author; // agregado de Usuario
	
	private List<CommentDTO> comments = new ArrayList<>(); // agregado de Comment, uma lista contendo os comentários do post
